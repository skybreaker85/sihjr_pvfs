	...
	SubShader {
	    ...
	    Pass {
			...
			half4 frag (v2f i) : COLOR{		
		    	...
		    	//if (texCol.a > 0.0) {
		    	if (texcol.r > 0.1 || texcol.g > 0.1 || texcol.b > 0.1) {
		    	//if (texcol.r == 1.0 && texcol.g == 1.0 && texcol.b == 1.0 && texCol.a == 1.0) {
		    		//finalColor=half4(texcol.r,texcol.g,texcol.b,texcol.a);
		    		finalColor=half4(texcol.r,texcol.g,texcol.b,texcol.a);
					//finalColor=half4(0.0,.1,1,0.5);
					//finalColor=floor((finalColor/0.2)*0.5);
					finalColor.a = floor((finalColor.a/0.30)*0.5);
